...
export default function ChatInput({ sendMessage, disabled, helpText, setHelpText }) {
    ...
    return (
        <div className="chatInput">
            <button className="iconBtn" onClick={() => setShowCalendar(!showCalendar)} title="Select travel date(s)" disabled={disabled}>
                📅
            </button>
            ...
            <input value={text} onChange={(e) => setText(e.target.value)} onKeyDown={handleKeyPress} placeholder={disabled ? "Trainbot is typing..." : "Type a message..."}maxLength={max_char} disabled={disabled}/>
